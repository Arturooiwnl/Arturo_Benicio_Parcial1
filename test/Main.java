...
public class Main {
    public static void main(String[] args) {
        ...
        if (gastronomia != null) {
            System.out.println("Precio final con descuento (gastronomia): " + gastronomia.calcularPrecioFinal(LocalDate.of(2020, 10, 28))); // precio con descuento
        }

        System.out.println("-------[2-2]-------");
        Servicio hospedaje = sistema.traerServicio("287282");
        if (hospedaje != null) {
            System.out.println("Precio final con descuento (hospedaje): " + hospedaje.calcularPrecioFinal(LocalDate.of(2020, 10, 27))); // precio con descuento
        }
        ...
        for (Servicio servicio : sistema.traerServiciosEnPromocion()) {
            System.out.println("Servicio en promocion: " + servicio.getCodServicio());
        }
        ...
        for (Servicio servicio : sistema.traerServiciosEnPromocion(LocalDate.of(2020, 10, 28))) {
            System.out.println("Servicio en promocion el 2020-10-28: " + servicio.getCodServicio());
        }
    }
}
